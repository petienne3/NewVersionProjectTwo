...
public class EmployeeRepository {
		...
		@Transactional(propagation = Propagation.REQUIRED)
		public void createPassword(Credentials credentials) {
			Session session = sf.getCurrentSession();
			String hql = "UPDATE employee set employeepassword = :employeepassword"+
			" WHERE employeeemail = credentials.getUserEmail";
			Query query = session.createQuery(hql);
			query.setParameter("employeepassword",credentials.getPassword());			
		}
